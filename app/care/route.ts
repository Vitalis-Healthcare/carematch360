...
.process-step h4 {
  font-family: 'Cormorant Garamond', serif;
  font-size: 18px; font-weight: 600; color: var(--green-dark); margin-bottom: 8px;
}
...
<section class="hero">
  ...
  <div class="hero-actions">
    ...
    <a href="tel:+13015550100" class="btn-hero-ghost">📞 Call Us Today</a>
  </div>
  ...
  <div class="form-shell">
      ...
      <div class="panel-body">
        ...
        <div class="row cols-2">
          ...
          <div class="field">
            ...
            <input type="tel" id="contact_phone" placeholder="(301) 555-0100"/>
          </div>
        </div>
    ...
    <div id="success">
      ...
      <div style="margin-top:20px;font-size:13px;color:var(--muted)">
        Need immediate assistance? Call <strong style="color:var(--green-dark)">(301) 555-0100</strong>
      </div>
    </div>
  </div>
</section>
...
async function submitForm() {
  ...
  try {
    const res = await fetch('https://carematch360.vercel.app/api/clients/inquire', {
      method: 'POST',
